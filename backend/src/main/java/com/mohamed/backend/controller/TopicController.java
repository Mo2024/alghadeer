...
import com.mohamed.backend.service.TopicService;
...
public class TopicController {
    ...
    public ResponseEntity<?> createMainTopic(@RequestBody MainTopic mainTopic){
        try {
            Response response = topicService.createMainTopic(mainTopic);
    ...
    public ResponseEntity<?> createSubTopic(@RequestBody SubTopic subTopic){
        try {
            Response response = topicService.createSubTopic(subTopic);
            return ResponseEntity.ok().body(response);
        } catch (UnhandledRejection e) {
            return ResponseEntity
                    .badRequest()
