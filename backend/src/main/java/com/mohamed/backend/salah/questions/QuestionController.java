...
@Slf4j
@RestController
@RequestMapping("/api/salah/questions")
@RequiredArgsConstructor
@Tag(name = "Salah Questions Management", description = "Operations related to questions entity for salah module")
public class QuestionController {

    private final QuestionService questionService;
    private final Logger logger;

    @GetMapping("/all/get-questions-by-level")
    @Operation(
            summary = "Gets questions by level",
    ...
    public ResponseEntity<?> getQuestionsByLevel(@RequestParam Level level) {
        try {
            log.info("executing method [questionService].[getQuestionsByLevel]");
            List<Question> response = questionService.getQuestionsByLevel(level);
            log.info("[questionService].[getQuestionsByLevel] executed successfully");
            logger.logJsonObject("Response for [getQuestionsByLevel]:\n{}", response);
    ...
    @PutMapping("/admin/edit-question")
    @Operation(
    ...
    @DeleteMapping("/admin/delete-question")
    @Operation(
